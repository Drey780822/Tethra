  ...
  head: () => ({
    meta: [
      ...
      { title: "Tethra — Target. Do. Prioritise. Complete." },
      {
        name: "description",
        content:
          "Tethra is a calm personal whiteboard for your tasks: target it, do it, prioritise it, complete it.",
      },
      { property: "og:title", content: "Tethra — Target. Do. Prioritise. Complete." },
      { property: "og:description", content: "A minimal personal task whiteboard." },
